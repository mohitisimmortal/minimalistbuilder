...
export default function Home() {
  return (
    <main className={`text-white ${inter.className} flex flex-col items-center justify-center h-screen `}>
      ...
      <button className="button1 flex items-center gap-1 mt-2 px-4 py-2 border border-white text-sm  md:text-base xl:text-lg font-medium rounded-md text-black bg-white hover:bg-transparent hover:text-white">
        Start Now

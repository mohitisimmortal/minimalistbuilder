...
const Header = () => {
    ...
    const toggleDropdown = () => {
        ...
        else { setDropdownOpen(!isDropdownOpen) }
    }
    // Sync session state with recoil state
    useEffect(() => {
        if (session) {
            setAuth(session);
        }
    ...
    //         signIn('google'); // Specify 'google' if it's the only provider
    //     }
    // };
    return (
        <>
                            ...
                            <div >
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent>
                                        ...
                                        <DropdownMenuItem onSelect={() => signIn('google')}>Sign out</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </div>
                        )}
